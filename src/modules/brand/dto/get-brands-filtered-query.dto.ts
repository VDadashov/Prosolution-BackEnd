...
/** GET /brands/filtered – pagination, isDeleted, isActive, search, sort (a-z | z-a | createdAt). */
export class GetBrandsFilteredQueryDto extends PaginationQueryDto {
  ...
  @ApiPropertyOptional({ description: 'true = silinmiş brendləri də göstər' })
  @IsOptional()
